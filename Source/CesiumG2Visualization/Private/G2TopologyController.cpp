...
#include "G2TopologyController.h"
#include "JsonParser.h"
#include "ReztlyLibrary.h"

// Sets default values
AG2TopologyController::AG2TopologyController()
{
...
void AG2TopologyController::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void AG2TopologyController::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

UG2Snapshot* AG2TopologyController::GetSnapshot()
{
	return Snapshot;
}
...
void AG2TopologyController::OnBearerTokenResponse(FString ResponseContentString,
	bool bWasSuccessful) {
	if (bWasSuccessful) {
...
void AG2TopologyController::OnSnapshotRangeResponse(FString ResponseContentString,
	bool bWasSuccessful) {
	if (bWasSuccessful) {
...
void AG2TopologyController::RequestLatestSnapshot() {
...
void AG2TopologyController::OnSnapshotResponse(FString ResponseContentString,
	bool bWasSuccessful) {
	if (bWasSuccessful) {
...
void AG2TopologyController::RequestUE4DataUtilsData() {
	FStringResponseDelegate Delegate;
	Delegate.BindUFunction(this, FName("OnUE4DataUtilsResponse"));
	UReztly::RequestUE4NautilusData(UE4NautilusDataUtilsURL, Delegate);
}

void AG2TopologyController::OnUE4DataUtilsResponse(FString ResponseContentString,
	bool bWasSuccessful) {
	if (bWasSuccessful) {
		UE_LOG(LogTemp, Log, TEXT("Snapshot Request Successful"));
		UE_LOG(LogTemp, Log, TEXT("Response Body: %s"),
...
void AG2TopologyController::ParseUE4Data(FUE4Response UE4Response) {
...
void AG2TopologyController::ParseG2Snapshot(FG2SnapshotResponse SnapshotIn) {
...
void AG2TopologyController::ParseLocationData(TArray<FLocationStruct> NetboxLocations)
{
...
void AG2TopologyController::ParseRackData(TArray<FRackStruct> NetboxRacks)
{
...
void AG2TopologyController::ParseLinkData(TArray<FLink> SnapshotLinks) {
...
void AG2TopologyController::ParseFlowData(TArray<FFlow> SnapshotFlows) {
	/*
...
void AG2TopologyController::ParseNodeInfo(FString Info, FString& IPAddress,
	float& MTU) {
	// Find IP Address
...
void AG2TopologyController::RequestNetboxRegionPatch(FRegionStruct Region)
{
	FStringResponseDelegate Delegate;
...
void AG2TopologyController::OnNetboxRegionPatchResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::OnNetboxSitesGetResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful && !ResponseContentString.Contains("\"error\": \"connection to server at")) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::OnNetboxSitePatchResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::RequestNetboxLocationsGet()
{
	FStringResponseDelegate Delegate;
...
void AG2TopologyController::OnNetboxLocationsGetResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful && !ResponseContentString.Contains("\"error\": \"connection to server at")) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::RequestNetboxLocationPatch(FLocationStruct Location)
{
	FStringResponseDelegate Delegate;
	Delegate.BindUFunction(this, FName("OnNetboxSitePatchResponse"));
...
void AG2TopologyController::OnNetboxLocationPatchResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::RequestNetboxRacksGet()
{
	FStringResponseDelegate Delegate;
...
void AG2TopologyController::OnNetboxRacksGetResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful && !ResponseContentString.Contains("\"error\": \"connection to server at")) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::RequestNetboxRackPatch(FRackStruct Rack)
{
	FStringResponseDelegate Delegate;
...
void AG2TopologyController::OnNetboxRackPatchResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::OnNetboxDevicesResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful) {
		UE_LOG(LogTemp, Log, TEXT("Netbox Request Successful"));
...
void AG2TopologyController::ParseNetboxDeviceData(FNetboxDeviceResponse NetboxResponse)
{
...
void AG2TopologyController::CrossReferenceNodeData() {
...
bool AG2TopologyController::CompareNodeToNetboxDeviceData(UG2Node* Node) {
	if (Node->MTU == 0)
	{
...
void AG2TopologyController::OnNetboxPostDeviceResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful) {
...
void AG2TopologyController::RequestNetboxDevicesPatch()
{
	TArray<FDeviceStruct> DeviceBatch;
...
void AG2TopologyController::OnNetboxPatchDeviceResponse(FString ResponseContentString,
	bool bWasSuccessful)
{
	if (bWasSuccessful) {
...
bool AG2TopologyController::IsHop(FString Name) {
